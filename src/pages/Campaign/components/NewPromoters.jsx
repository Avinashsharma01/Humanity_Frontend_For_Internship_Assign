            ...
            <div className="space-y-4">
                ...
                <div className="border rounded-lg overflow-hidden">
                    ...
                    <div className="flex border-b">
                        <button className="px-4 py-2 text-sm border-r">
                            Chat with AI
                        </button>
                        <button className="px-4 py-2 text-sm border-r">
                            My Leads
                    ...
                    <div className="p-6 bg-gray-50 min-h-[250px]">
                        <div className="text-center space-y-3">
                            ...
                            <p className="text-sm text-gray-600 max-w-md mx-auto">
                                SnackNation delivers hand-picked, chef-curated
                                snacks — from spicy wasabi nuts to sweet pastry
                                treats — delivered fresh to your door in under
                                45 minutes.
                            </p>

                            <div className="bg-white p-4 rounded-lg shadow-sm mt-6">
                                <p className="font-medium">
                                    Every successful referral earns you 200
                                    points
                                </p>
                            </div>
