...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const userData = {
                // Include all response data (including tokens)
                ...responseData,
                // If API returns access token, use new names
                ...
                name: responseData.user?.name || responseData.user?.full_name || formData.email.split('@')[0]
            };
            ...
            // Log user data after setting in context
