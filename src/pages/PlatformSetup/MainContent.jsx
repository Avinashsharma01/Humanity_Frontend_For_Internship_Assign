...
const MainContent = () => {
  ...
  const getStepContent = () => {
    switch (currentStep) {
      case 0:
        return <BusinessIdentityForm onSubmit={handleStepSubmit} initialData={formData.businessIdentity} />;
      case 1:
        return <CustomerDataForm onSubmit={handleStepSubmit} initialData={formData.customerData} />;
      case 2:
        return <ReferralRewardsForm onSubmit={handleStepSubmit} initialData={formData.referralRewards} />;
      case 3:
        return <AgentRulesForm onSubmit={handleStepSubmit} initialData={formData.agentRules} />;
      case 4:
        return <DetailedCampaignForm onSubmit={handleStepSubmit} initialData={formData.detailedCampaign} />;
      default:
        return <BusinessIdentityForm onSubmit={handleStepSubmit} initialData={formData.businessIdentity} />;
    }
  };
      ...
      <div className="p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-6 flex justify-between items-center">
            <h1 className="text-xl font-semibold text-gray-800">Platform Setup</h1>
